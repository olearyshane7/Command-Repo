...
def generate_ip_config_two( usable_in_cidr, gw_ip, network_in_cidr):
        ...
        try:
            ...
            messagebox.showerror("Invalid Input", "Network cidr must be a valid IPv4 address in the format 192.168.1.1")
            return

        config_ip2_template = f"""
configuration
interface lte lte-1
admin down
...
"""
        ...
        pyperclip.copy(config_ip2_template)
